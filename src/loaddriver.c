...
//    LPCWSTR testRegPath = L"SYSTEM\\CurrentControlSet\\Services\\testtest";
...
//    BeaconPrintf(CALLBACK_OUTPUT, "fullRegPath: %ls\n",fullRegPath);
//    BeaconPrintf(CALLBACK_OUTPUT, "relativeRegPath: %ls\n",relativeRegPath);
